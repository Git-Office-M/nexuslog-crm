...
export default function Layout({ page, setPage, children, counts = {} }) {
  ...
  const labels = {
    ...
    visits: 'Visitas', catalog: 'Catálogo HELI', detail: 'Detalhe',
    settings: 'Configurações', privacidade: 'Política de Privacidade',
  };
    ...
    <>
      <style>{`
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .sidebar{width:240px;background:#111827;display:flex;flex-direction:column;position:fixed;top:0;left:0;bottom:0;z-index:200;transition:transform .25s ease;}
        ...
        .sb-header{padding:20px 18px 16px;border-bottom:1px solid rgba(255,255,255,.07);display:flex;align-items:center;justify-content:space-between;}
        .logo-row{display:flex;align-items:center;gap:10px}
        .logo-badge{width:36px;height:36px;border-radius:8px;background:#C10A25;display:flex;align-items:center;justify-content:center;font-size:13px;font-weight:800;color:#fff;flex-shrink:0;font-family:'Syne',sans-serif;}
        ...
        .sb-item{display:flex;align-items:center;gap:10px;padding:10px 10px;border-radius:8px;cursor:pointer;font-size:14px;font-weight:500;color:rgba(255,255,255,.5);background:transparent;border:none;width:100%;text-align:left;font-family:'Inter',sans-serif;margin-bottom:2px;transition:all .15s;}
        ...
        .user-av{width:32px;height:32px;border-radius:50%;background:rgba(193,10,37,.25);border:1px solid rgba(193,10,37,.4);display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:700;color:#C10A25;flex-shrink:0;}
        ...
        .sign-out{margin-top:6px;width:100%;background:transparent;border:none;color:rgba(255,255,255,.25);font-size:12px;cursor:pointer;text-align:left;font-family:'Inter',sans-serif;padding:3px 0;}
        .sign-out:hover{color:rgba(255,255,255,.5)}
        .main{flex:1;display:flex;flex-direction:column;min-height:100vh;width:100%}
        .topbar{height:52px;background:#fff;border-bottom:1px solid #e5e7eb;display:flex;align-items:center;justify-content:space-between;padding:0 14px;position:sticky;top:0;z-index:100;}
      ...
      <div className="app">
        ...
        <aside className={`sidebar${open?' open':''}`}>
          ...
          <div className="sb-footer">
            ...
            <button className="sign-out" onClick={() => go('privacidade')}>🔒 Política de Privacidade</button>
          </div>
        </aside>
